                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%; text-indent: calc(50% - 60px);">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="category_discount" id="exampleInputEmail1" placeholder="Enter Category Discount">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Category Description</label>
                        <textarea rows="5" cols="5" class="form-control" name="category_description" id="exampleInputEmail1" placeholder="Enter Category Description"></textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%; height: 100px;">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="category_url" id="exampleInputEmail1" placeholder="Enter Category URL">
                    </div>
